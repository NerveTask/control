...
function control_scripts() {
	...
	wp_enqueue_style('control_main', get_template_directory_uri() . '/assets/css/main.min.css', false, 'c519ac6b75d96a507206f87cccdbe412');
	...
	wp_register_script('control_scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', array(), 'd13d44fe7c085fcdaaa839277f22a49e', true);
